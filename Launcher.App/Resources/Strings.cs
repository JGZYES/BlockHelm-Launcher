...
public static class Strings
{
    ...
    public static string Multiplayer_Create_SelectGameInstanceSection => Get(nameof(Multiplayer_Create_SelectGameInstanceSection));
    public static string Multiplayer_Create_GameInstancePlaceholder => Get(nameof(Multiplayer_Create_GameInstancePlaceholder));
    public static string Multiplayer_Create_LanWorldRefreshHint => Get(nameof(Multiplayer_Create_LanWorldRefreshHint));
    public static string Multiplayer_Create_LanWorldDiscovering => Get(nameof(Multiplayer_Create_LanWorldDiscovering));
    public static string Multiplayer_Create_LanWorldNotFound => Get(nameof(Multiplayer_Create_LanWorldNotFound));
    public static string Multiplayer_Create_LanWorldDiscoveryFailed => Get(nameof(Multiplayer_Create_LanWorldDiscoveryFailed));
    public static string Multiplayer_Create_MultipleLanWorldsWarning => Get(nameof(Multiplayer_Create_MultipleLanWorldsWarning));
    public static string Multiplayer_Create_CreatingLobby => Get(nameof(Multiplayer_Create_CreatingLobby));
    ...
    public static string Multiplayer_Create_UnknownLanWorld => Get(nameof(Multiplayer_Create_UnknownLanWorld));
    public static string Multiplayer_Create_LanWorldItemFormat => Get(nameof(Multiplayer_Create_LanWorldItemFormat));
