...
public static class Strings
{
    ...
    public static string Dialog_TerracottaAgreementTitle => Get(nameof(Dialog_TerracottaAgreementTitle));
    public static string Dialog_TerracottaAgreementMessage => Get(nameof(Dialog_TerracottaAgreementMessage));
    public static string Dialog_TerracottaProjectLink => Get(nameof(Dialog_TerracottaProjectLink));
    public static string Dialog_TerracottaDisagreeButton => Get(nameof(Dialog_TerracottaDisagreeButton));
    public static string Dialog_TerracottaAgreeButton => Get(nameof(Dialog_TerracottaAgreeButton));
    public static string Dialog_TerracottaDownloadPreparing => Get(nameof(Dialog_TerracottaDownloadPreparing));
    public static string Dialog_TerracottaDownloading => Get(nameof(Dialog_TerracottaDownloading));
    public static string Dialog_TerracottaExtracting => Get(nameof(Dialog_TerracottaExtracting));
    public static string Dialog_TerracottaDownloadComplete => Get(nameof(Dialog_TerracottaDownloadComplete));
    public static string Dialog_TerracottaDownloadFailed => Get(nameof(Dialog_TerracottaDownloadFailed));
    public static string Status_TerracottaReady => Get(nameof(Status_TerracottaReady));
    public static string Status_TerracottaDownloadFailed => Get(nameof(Status_TerracottaDownloadFailed));
    public static string Status_OpenTerracottaProjectFailed => Get(nameof(Status_OpenTerracottaProjectFailed));
    ...
    public static string Page_Multiplayer => Get(nameof(Page_Multiplayer));
    public static string Multiplayer_SectionCreateLobby => Get(nameof(Multiplayer_SectionCreateLobby));
    public static string Multiplayer_SectionJoinLobby => Get(nameof(Multiplayer_SectionJoinLobby));
    public static string Multiplayer_Create_LobbyFailed => Get(nameof(Multiplayer_Create_LobbyFailed));
    public static string Multiplayer_Create_TerracottaUnavailable => Get(nameof(Multiplayer_Create_TerracottaUnavailable));
    public static string Multiplayer_Create_WorldUnavailable => Get(nameof(Multiplayer_Create_WorldUnavailable));
    public static string Multiplayer_Create_TerracottaBusy => Get(nameof(Multiplayer_Create_TerracottaBusy));
    public static string Multiplayer_Create_TerracottaProtocolFailed => Get(nameof(Multiplayer_Create_TerracottaProtocolFailed));
    ...
    public static string Multiplayer_Join_StepEnterRoomCode => Get(nameof(Multiplayer_Join_StepEnterRoomCode));
    public static string Multiplayer_Join_StepJoinLobby => Get(nameof(Multiplayer_Join_StepJoinLobby));
    public static string Multiplayer_Join_RoomCodeSection => Get(nameof(Multiplayer_Join_RoomCodeSection));
    public static string Multiplayer_Join_RoomCodePlaceholder => Get(nameof(Multiplayer_Join_RoomCodePlaceholder));
    public static string Multiplayer_Join_PasteButton => Get(nameof(Multiplayer_Join_PasteButton));
    public static string Multiplayer_Join_Joining => Get(nameof(Multiplayer_Join_Joining));
    public static string Multiplayer_Join_InvalidRoomCode => Get(nameof(Multiplayer_Join_InvalidRoomCode));
    public static string Multiplayer_Join_Failed => Get(nameof(Multiplayer_Join_Failed));
    public static string Multiplayer_Join_ClipboardEmpty => Get(nameof(Multiplayer_Join_ClipboardEmpty));
    ...
    public static string Multiplayer_LobbyRoomCodeHeader => Get(nameof(Multiplayer_LobbyRoomCodeHeader));
    public static string Multiplayer_LobbyRoomCodePlaceholder => Get(nameof(Multiplayer_LobbyRoomCodePlaceholder));
    public static string Multiplayer_LobbyPlayerListHeader => Get(nameof(Multiplayer_LobbyPlayerListHeader));
    public static string Multiplayer_LobbyPlayerPlaceholderFormat => Get(nameof(Multiplayer_LobbyPlayerPlaceholderFormat));
    public static string Multiplayer_LobbyClientIdPlaceholderFormat => Get(nameof(Multiplayer_LobbyClientIdPlaceholderFormat));
    public static string Multiplayer_LobbyLatencyPlaceholder => Get(nameof(Multiplayer_LobbyLatencyPlaceholder));
    public static string Multiplayer_LobbyLatencyUnknown => Get(nameof(Multiplayer_LobbyLatencyUnknown));
    public static string Multiplayer_LobbyLatencyFormat => Get(nameof(Multiplayer_LobbyLatencyFormat));
    public static string Multiplayer_LobbyRoomCodeCopied => Get(nameof(Multiplayer_LobbyRoomCodeCopied));
    public static string Multiplayer_LobbyRoomCodeCopyFailed => Get(nameof(Multiplayer_LobbyRoomCodeCopyFailed));
    public static string Multiplayer_LobbyDisbandFailed => Get(nameof(Multiplayer_LobbyDisbandFailed));
    public static string Multiplayer_LobbyWorldClosed => Get(nameof(Multiplayer_LobbyWorldClosed));
    public static string Multiplayer_LobbyTerracottaExited => Get(nameof(Multiplayer_LobbyTerracottaExited));
    public static string Multiplayer_LobbyTerracottaServiceFailed => Get(nameof(Multiplayer_LobbyTerracottaServiceFailed));
    public static string Multiplayer_LobbyPoweredByTerracotta => Get(nameof(Multiplayer_LobbyPoweredByTerracotta));
    public static string Multiplayer_LobbyPlayerRoleHost => Get(nameof(Multiplayer_LobbyPlayerRoleHost));
    public static string Multiplayer_LobbyPlayerRolePlayer => Get(nameof(Multiplayer_LobbyPlayerRolePlayer));
    public static string Multiplayer_LobbyPlayerRoleSelf => Get(nameof(Multiplayer_LobbyPlayerRoleSelf));
    public static string Multiplayer_LobbyLeaveAndDisbandButton => Get(nameof(Multiplayer_LobbyLeaveAndDisbandButton));
    public static string Multiplayer_LobbyLeaveButton => Get(nameof(Multiplayer_LobbyLeaveButton));
    public static string Multiplayer_LobbyLeaveFailed => Get(nameof(Multiplayer_LobbyLeaveFailed));
    public static string Dialog_MultiplayerLeaveLobbyTitle => Get(nameof(Dialog_MultiplayerLeaveLobbyTitle));
    public static string Dialog_MultiplayerLeaveLobbyMessage => Get(nameof(Dialog_MultiplayerLeaveLobbyMessage));
    public static string Dialog_MultiplayerLeaveLobbyConfirmButton => Get(nameof(Dialog_MultiplayerLeaveLobbyConfirmButton));
    public static string Dialog_MultiplayerLeaveJoinedLobbyTitle => Get(nameof(Dialog_MultiplayerLeaveJoinedLobbyTitle));
    public static string Dialog_MultiplayerLeaveJoinedLobbyMessage => Get(nameof(Dialog_MultiplayerLeaveJoinedLobbyMessage));
    public static string Dialog_MultiplayerLeaveJoinedLobbyConfirmButton => Get(nameof(Dialog_MultiplayerLeaveJoinedLobbyConfirmButton));
    public static string Dialog_MultiplayerLobbySectionSwitchBlockedTitle => Get(nameof(Dialog_MultiplayerLobbySectionSwitchBlockedTitle));
    public static string Dialog_MultiplayerLobbySectionSwitchBlockedMessage => Get(nameof(Dialog_MultiplayerLobbySectionSwitchBlockedMessage));
    public static string Dialog_MultiplayerLanWorldDetectionTitle => Get(nameof(Dialog_MultiplayerLanWorldDetectionTitle));
    public static string Dialog_MultiplayerLanWorldDetectionMessage => Get(nameof(Dialog_MultiplayerLanWorldDetectionMessage));
    ...
    public static string Resources_SectionJava => Get(nameof(Resources_SectionJava));
    ...
    public static string Settings_CustomFileDownloadSection => Get(nameof(Settings_CustomFileDownloadSection));
    public static string Settings_CustomFileDownloadNewTaskLabel => Get(nameof(Settings_CustomFileDownloadNewTaskLabel));
    public static string Settings_CustomFileDownloadNewTaskButton => Get(nameof(Settings_CustomFileDownloadNewTaskButton));
    public static string Dialog_CustomFileDownloadTitle => Get(nameof(Dialog_CustomFileDownloadTitle));
    public static string Dialog_CustomFileDownloadAddressLabel => Get(nameof(Dialog_CustomFileDownloadAddressLabel));
    public static string Dialog_CustomFileDownloadAddressValidation => Get(nameof(Dialog_CustomFileDownloadAddressValidation));
    public static string Dialog_CustomFileDownloadDownloadButton => Get(nameof(Dialog_CustomFileDownloadDownloadButton));
    public static string FilePicker_CustomFileDownloadTitle => Get(nameof(FilePicker_CustomFileDownloadTitle));
    public static string FilePicker_CustomFileDownloadFilter => Get(nameof(FilePicker_CustomFileDownloadFilter));
    public static string Status_CustomFileDownloadPreparing => Get(nameof(Status_CustomFileDownloadPreparing));
    public static string Status_CustomFileDownloadStartedFormat => Get(nameof(Status_CustomFileDownloadStartedFormat));
    public static string Status_CustomFileDownloading => Get(nameof(Status_CustomFileDownloading));
    public static string Status_CustomFileDownloadCompleted => Get(nameof(Status_CustomFileDownloadCompleted));
    public static string Status_CustomFileDownloadFailed => Get(nameof(Status_CustomFileDownloadFailed));
    ...
    public static string GameSettings_DetailExport => Get(nameof(GameSettings_DetailExport));
    public static string GameSettings_DetailPlayTime => Get(nameof(GameSettings_DetailPlayTime));
    public static string GameSettings_DropAutoRouteMessageFormat => Get(nameof(GameSettings_DropAutoRouteMessageFormat));
    public static string GameSettings_DropTypeMod => Get(nameof(GameSettings_DropTypeMod));
    public static string GameSettings_DropTypeWorld => Get(nameof(GameSettings_DropTypeWorld));
    public static string GameSettings_DropTypeResourcePack => Get(nameof(GameSettings_DropTypeResourcePack));
    public static string GameSettings_DropTypeShaderPack => Get(nameof(GameSettings_DropTypeShaderPack));
    public static string GameSettings_DropTypeModpack => Get(nameof(GameSettings_DropTypeModpack));
    public static string PlayTime_TotalPlayTime => Get(nameof(PlayTime_TotalPlayTime));
    public static string PlayTime_TodayPlayTime => Get(nameof(PlayTime_TodayPlayTime));
    public static string PlayTime_WeekPlayTime => Get(nameof(PlayTime_WeekPlayTime));
    public static string PlayTime_SessionCount => Get(nameof(PlayTime_SessionCount));
    public static string PlayTime_LastPlayed => Get(nameof(PlayTime_LastPlayed));
    public static string PlayTime_NoHistory => Get(nameof(PlayTime_NoHistory));
    public static string PlayTime_LessThanOneMinute => Get(nameof(PlayTime_LessThanOneMinute));
    public static string PlayTime_MinutesFormat => Get(nameof(PlayTime_MinutesFormat));
    public static string PlayTime_HoursMinutesFormat => Get(nameof(PlayTime_HoursMinutesFormat));
    public static string PlayTime_RecentSessions => Get(nameof(PlayTime_RecentSessions));
    ...
    public static string GameSettings_ExportSettingsSection => Get(nameof(GameSettings_ExportSettingsSection));
    public static string GameSettings_ExportModpackTypeLabel => Get(nameof(GameSettings_ExportModpackTypeLabel));
    public static string GameSettings_ExportTypeCurseForge => Get(nameof(GameSettings_ExportTypeCurseForge));
    public static string GameSettings_ExportTypeModrinth => Get(nameof(GameSettings_ExportTypeModrinth));
    public static string GameSettings_ExportModpackInfoSection => Get(nameof(GameSettings_ExportModpackInfoSection));
    public static string GameSettings_ExportModpackNameLabel => Get(nameof(GameSettings_ExportModpackNameLabel));
    public static string GameSettings_ExportModpackNameRequired => Get(nameof(GameSettings_ExportModpackNameRequired));
    public static string GameSettings_ExportAuthorLabel => Get(nameof(GameSettings_ExportAuthorLabel));
    public static string GameSettings_ExportAuthorHint => Get(nameof(GameSettings_ExportAuthorHint));
    public static string GameSettings_ExportVersionLabel => Get(nameof(GameSettings_ExportVersionLabel));
    public static string GameSettings_ExportVersionPlaceholder => Get(nameof(GameSettings_ExportVersionPlaceholder));
    public static string GameSettings_ExportPackModsLabel => Get(nameof(GameSettings_ExportPackModsLabel));
    public static string GameSettings_ExportPackDisabledModsLabel => Get(nameof(GameSettings_ExportPackDisabledModsLabel));
    public static string GameSettings_ExportPackResourcePacksLabel => Get(nameof(GameSettings_ExportPackResourcePacksLabel));
    public static string GameSettings_ExportPackShaderPacksLabel => Get(nameof(GameSettings_ExportPackShaderPacksLabel));
    public static string GameSettings_ExportPackSavesLabel => Get(nameof(GameSettings_ExportPackSavesLabel));
    ...
    public static string Account_TypeThirdPartyTitle => Get(nameof(Account_TypeThirdPartyTitle));
    public static string Account_TypeThirdPartyDescription => Get(nameof(Account_TypeThirdPartyDescription));
    public static string Account_AuthenticationServerLabel => Get(nameof(Account_AuthenticationServerLabel));
    public static string Account_AuthenticationServerPlaceholder => Get(nameof(Account_AuthenticationServerPlaceholder));
    public static string Account_UsernameOrEmailLabel => Get(nameof(Account_UsernameOrEmailLabel));
    public static string Account_PasswordLabel => Get(nameof(Account_PasswordLabel));
    public static string Account_ThirdPartyServerRequired => Get(nameof(Account_ThirdPartyServerRequired));
    public static string Account_ThirdPartyUsernameRequired => Get(nameof(Account_ThirdPartyUsernameRequired));
    public static string Account_ThirdPartyPasswordRequired => Get(nameof(Account_ThirdPartyPasswordRequired));
    public static string Account_ThirdPartyServerInvalid => Get(nameof(Account_ThirdPartyServerInvalid));
    public static string Account_ThirdPartyServerHttpsRequired => Get(nameof(Account_ThirdPartyServerHttpsRequired));
    public static string Account_ThirdPartyServerUnavailable => Get(nameof(Account_ThirdPartyServerUnavailable));
    public static string Account_ThirdPartyServerInvalidResponse => Get(nameof(Account_ThirdPartyServerInvalidResponse));
    public static string Account_ThirdPartyUsernameUnsupported => Get(nameof(Account_ThirdPartyUsernameUnsupported));
    public static string Account_ThirdPartyProfileMissing => Get(nameof(Account_ThirdPartyProfileMissing));
    ...
    public static string Dialog_AddThirdPartyAccountTitle => Get(nameof(Dialog_AddThirdPartyAccountTitle));
    ...
    public static string Dialog_AddThirdPartyAccountSubtitle => Get(nameof(Dialog_AddThirdPartyAccountSubtitle));
    public static string Dialog_ReauthenticateThirdPartyAccountSubtitle => Get(nameof(Dialog_ReauthenticateThirdPartyAccountSubtitle));
    ...
    public static string Status_ThirdPartyReauthenticationRequired => Get(nameof(Status_ThirdPartyReauthenticationRequired));
    public static string Account_ThirdPartyPlatformFormat => Get(nameof(Account_ThirdPartyPlatformFormat));
    public static string Status_MicrosoftReauthenticationRequired => Get(nameof(Status_MicrosoftReauthenticationRequired));
    ...
    public static string Dialog_ThirdPartyProfileSelectionSubtitle => Get(nameof(Dialog_ThirdPartyProfileSelectionSubtitle));
    public static string Dialog_ThirdPartyImportProgressTitle => Get(nameof(Dialog_ThirdPartyImportProgressTitle));
    public static string Dialog_ThirdPartyImportProgressSubtitle => Get(nameof(Dialog_ThirdPartyImportProgressSubtitle));
    public static string Dialog_ThirdPartyImportResultTitle => Get(nameof(Dialog_ThirdPartyImportResultTitle));
    public static string Dialog_ThirdPartyImportResultSubtitle => Get(nameof(Dialog_ThirdPartyImportResultSubtitle));
    public static string Dialog_ThirdPartyImportProgressFormat => Get(nameof(Dialog_ThirdPartyImportProgressFormat));
    public static string Dialog_ThirdPartyImportFailureFormat => Get(nameof(Dialog_ThirdPartyImportFailureFormat));
    ...
    public static string Status_ModpackExportFailed => Get(nameof(Status_ModpackExportFailed));
